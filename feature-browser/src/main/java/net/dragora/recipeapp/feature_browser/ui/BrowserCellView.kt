...
import kotlinx.android.synthetic.main.browser_cell.view.browser_cell_overlay
...
class BrowserCellView(context: Context) : LokiFrameLayout(context, R.layout.browser_cell) {
    ...
    fun bind(
        ...
        browser_cell_overlay.setOnClickListener {
            clickCell.invoke(viewModel.recipeId)
        }
